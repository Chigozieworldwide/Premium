...
def cek_login():
    ...
    with requests.Session() as ses_dev:
        ...
        try:
            login_coki = ses_dev.get(url, cookies = {
                'cookie': cok }, headers = headerz_api)
...
def login_dev_cookie():
    ...
    with requests.Session() as ses_dev:
        login_coki = ses_dev.get(url_instagram, cookies = {
            'cookie': cok }, headers = headerz)
    ...
    try:
        ...
        try:
            ...
            param = {
                ...
                'enc_password': '#PWD_INSTAGRAM_BROWSER:0:{}:{}'.format(random.randint(1000000000, ), pass_dev),
                'optIntoOneTap': False,
                'queryParams': { },
                'stopDeletionNonce': '',
...
def info_dev(username_dev, pass_dev, status):
    ...
    try:
        da = requests.get('https://www.instagram.com/{}/?__a=1'.format(username_dev), headers = {
            'User-Agent': user_agentz })
