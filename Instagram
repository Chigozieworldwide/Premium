...
def __apikey__ ():#line:33
  try :#line:34
    ...
    OO00O0OO0OOOO0OOO =input (f"{H}[{P}?{H}]{P} Apikey :{T} ")#line:36
    if OO00O0OO0OOOO0OOO in ['get','Get','GET']:#line:37
      ...
      O000OOOOO00OO0OOO ={'token':'WyIxNjI5NTcwOSIsImhDaGhxdzg3TUtnN1IyeGpMOWFhUVVuL01DY0g1ZlJ4QUoxd3N5Z1AiXQ==','productid':'14640','key':OO00O0OO0OOOO0OOO ,'sigin':True }#line:45
